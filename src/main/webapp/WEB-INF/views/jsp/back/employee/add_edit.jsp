...
<div class="am-g am-margin-top-xl">
    <div class="am-u-sm-12 am-u-md-9 am-u-lg-4 am-u-sm-centered">
        ...
        <div class="am-input-group am-input-group-primary">
            ...
            <input id="phone" type="text" class="am-form-field whiteback" value="<%=employee.getPhone()!=null?employee.getPhone():""%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">入职时间</span>
            <input id="entrytime" type="date" class="am-form-field whiteback" value="<%=employee.getEntryTime()!=null?employee.getEntryTime():""%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">所属部门</span>
            <input id="department" type="text" class="am-form-field whiteback" value="<%=employee.getDepartment()!=null?employee.getDepartment():""%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
            ...
            <select id="role" style="width: 100%;font-size: large;margin-top: 7px; border: solid 1px deepskyblue;">
                <option <%=(employee.getRole() != null && 0 == employee.getRole()) ? "checked" : ""%> value="0">业务员</option>
                <option <%=(employee.getRole() != null && 1 == employee.getRole()) ? "checked" : ""%> value="1">副总监</option>
                <option <%=(employee.getRole() != null && 2 == employee.getRole()) ? "checked" : ""%> value="2">总监</option>
            </select>
        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">职&emsp;&emsp;务</span>
            <input id="duties" type="text" class="am-form-field whiteback" value="<%=employee.getDuties()!=null?employee.getDuties():""%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
