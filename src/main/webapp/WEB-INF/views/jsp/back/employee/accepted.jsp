...
<div class="am-g am-margin-top-xl">
    <div class="am-u-sm-12 am-u-md-9 am-u-lg-4 am-u-sm-centered">
        ...
        <div class="am-input-group am-input-group-primary">
            ...
            <input id="flerk" type="text" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getClerkName())%>"/>
        ...
        <div class="am-input-group am-input-group-primary">
            ...
            <input id="accept_time" type="date" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getAcceptTime())%>"/>
        </div>
        <!--TODO 输入提示-->
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">字母编码</span>
            <input id="latter_number" type="text" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getLetterNumber())%>"/>

        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">客户姓名</span>
            <input id="custom_name" type="text" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getCustomerName())%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">客户电话</span>
            <input id="custom_phone" type="number" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getCustomerPhone())%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
            ...
            <select id="business_type"
                ...
                <option <%=(accepted.getBusinessType()!=null&&1==accepted.getBusinessType())?"checked":""%>  value="1">抵押</option>
                <option <%=(accepted.getBusinessType()!=null&&2==accepted.getBusinessType())?"checked":""%> value="2">质押</option>
            </select>
        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">银行机构</span>
            <input id="agency" type="text" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getAgency())%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">业务性质</span>
            <input id="business_nature" type="text" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getBusinessNature())%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">预贷金额（万元）</span>
            <input id="want_money" type="number" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getWantMoney())%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">服务费比例</span>
            <input id="service_fee" type="text" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getServiceFee())%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">实收服务费（元）</span>
            <input id="service_fee_actual" type="number" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getServiceFeeActual())%>"/>
        </div>

        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">办结日期</span>
            <input id="end_time" type="date" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getEndDate())%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">批贷金额（万元）</span>
            <input id="loan_money" type="number" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getLoanMoney())%>"/>
        </div>
        <div class="am-input-group am-input-group-primary">
            ...
            <select id="service_agreement"
                ...
                <option <%=(accepted.getServiceAgreement()!=null&&0==accepted.getServiceAgreement())?"checked":""%> value="0">否</option>
            </select>
        </div>
        <div class="am-input-group am-input-group-primary">
            ...
            <select id="handle_status"
                ...
                <option <%=(accepted.getState()!=null&&2==accepted.getState())?"checked":""%> value="2">办结</option>
                <option <%=(accepted.getState()!=null&&3==accepted.getState())?"checked":""%> value="3">被拒</option>
            </select>
        </div>
        <div class="am-input-group am-input-group-primary">
            <span class="am-input-group-label">备&emsp;&emsp;注</span>
            <input id="beizhu" type="text" class="am-form-field whiteback" value="<%=Strings.getInputString(accepted.getBeizhu())%>"/>
        </div>
